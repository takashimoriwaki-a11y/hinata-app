...
<div class="card">
  ...
  <p class="note">
    ...
    res.setHeader('Content-Type', 'text/html; charset=utf-8');
    res.send(`<html><body style="background:#ffe0b2;padding:40px;text-align:center;font-family:sans-serif;">
      <h2 style="color:#92400e;">契約・看護記録Ⅰアプリ</h2>
      <p style="margin:20px 0;">アプリURL：</p>
      <a href="https://takashimoriwaki-a11y.github.io/hinata-app/" style="color:#1d4ed8;font-size:14px;">
        https://takashimoriwaki-a11y.github.io/hinata-app/
      </a>
    </body></html>`);
  }
